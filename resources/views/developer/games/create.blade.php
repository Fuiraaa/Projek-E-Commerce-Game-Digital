        ...
        <form id="gameForm" action="{{ route('developer.games.store') }}" method="POST" enctype="multipart/form-data" class="glass-card p-6">
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <input type="file" id="gameFileInput" name="game_file" accept=".zip" class="w-full px-4 py-3 rounded-lg bg-white/5 border border-white/10 text-white focus:border-neon-blue focus:ring-1 focus:ring-neon-blue outline-none transition-colors file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-neon-blue/20 file:text-neon-cyan file:cursor-pointer" required>
            ...
            <div id="uploadProgressContainer" class="hidden mt-6">
                <div class="flex items-center justify-between mb-1">
                    <span id="uploadFileName" class="text-xs text-gray-400 truncate max-w-[200px]">Uploading Game Assets...</span>
        ...
        form.addEventListener('submit', function(e) {
            ...
            xhr.upload.addEventListener('progress', function(e) {
                if (e.lengthComputable) {
                    ...
                    if (percent < 100) {
                        uploadStatus.textContent = 'Uploading ' + (e.loaded / 1024 / 1024).toFixed(1) + ' MB of ' + (e.total / 1024 / 1024).toFixed(1) + ' MB...';
                    } else {
                        uploadStatus.textContent = 'Upload complete! Please wait while we process and save the game data...';
                    }
                }
            });
            ...
            xhr.addEventListener('error', function() {
                uploadStatus.textContent = 'Upload failed. Please try again or check your connection.';
